...
endpoints = [
    ...
    ('GET', '/api/blog/<int:id>', view_blog.get_blog),
    ('PUT', '/api/blog/<int:id>', view_blog.put_blog),
    ('DELETE', '/api/blog/<int:id>', view_blog.del_blog),
    ...
    ('DELETE', '/api/comment/<int:comment_id>', view_blog.delete_comments),
